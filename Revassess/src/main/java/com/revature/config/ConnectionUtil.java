...
public class ConnectionUtil {
	...
	// add your jdbc url
	public static final String URL = "jdbc:oracle:thin:@ryanp2007.caupdsjl1rwa.us-east-2.rds.amazonaws.com:1521:ORCL";
	// add your jdbc username
	public static final String USERNAME = "ryan";
	// add your jdbc password
	public static final String PASSWORD = "bulldogcc";
	...
	public static final String TIER_3_SEQUENCE_NAME = "assess_seq";
